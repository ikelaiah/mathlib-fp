...
## Documentation information architecture milestone

The pre-capability documentation-readiness gate is complete: the maintained
site now leads with Start, task-oriented Guides, stable Reference material,
and current Project policies; release evidence is archived by version. This is
not a numerical or API release and does not alter target support claims.
...
| ------- | ------------ | ------- | ------------- |
| 1.2.0 | 2026-07-18 | Initial shared-type release: numeric types, real symmetric eigendecomposition, matrix powers, and seeded random/bootstrap paths | [notes](../releases/1.2.0/release-notes.md) |
| 1.2.1 | 2026-07-18 | Canonical terminology guide, public API naming inventory, and aligned README/FAQ/guides | [notes](../releases/1.2.1/release-notes.md) |
| 1.2.2 | 2026-07-18 | MathBase and NumericsLib walkthroughs; a runnable program and index for every documented domain | [notes](../releases/1.2.2/release-notes.md) |
| 1.2.3 | 2026-07-21 | Correctness and robustness release: special-function accuracy, convergence and tail behaviour, and overflow/underflow/cancellation removal | [notes](../releases/1.2.3/release-notes.md) |
| 1.3.0 | 2026-07-23 | Complex-number and vector foundation (`TComplex`, real/complex vector kernels) for later algebra and signal processing | [notes](../releases/1.3.0/release-notes.md) |
| 1.4.0 | 2026-07-25 | GeometryLib fixed-size vector arithmetic through natural operators | [notes](../releases/1.4.0/release-notes.md) |
| 1.5.0 | 2026-07-26 | Typed contiguous real/complex scalar, vector, and dense-matrix foundation with a direct `Solve` path | [notes](../releases/1.5.0/release-notes.md) |
| 1.6.0 | 2026-07-27 | Dependable typed dense linear algebra: LU/QR/CPQR/SVD and symmetric/Hermitian eigensystems with direct solves | [notes](../releases/1.6.0/release-notes.md) |
| 1.7.0 | 2026-07-30 | Numerical modelling and optimisation: interpolation, fitting, integration, equations, ODEs, differentiation, and optimisation | [notes](../releases/1.7.0/release-notes.md) |
| 1.8.0 | 2026-07-30 | Applied numerics, tooling, and performance maturity: FFT/DSP, probability/statistics, data analysis/time series, and interchange | [notes](../releases/1.8.0/release-notes.md) |
| 1.9.0 | 2026-08-01 | Scalable linear algebra and API convergence: typed structured/sparse storage, operators, iterative solvers, preconditioning, and 2.0 conventions | [notes](../releases/1.9.0/release-notes.md) |
| 1.9.1 | 2026-08-02 | Stabilisation and documentation delivery: 1.9.0 triage and versioned web/offline documentation | [notes](../releases/1.9.1/release-notes.md) |
| 1.9.2 | 2026-08-02 | Beginner learning path: runnable examples, common tasks, and choose-an-algorithm guidance for every domain | [notes](../releases/1.9.2/release-notes.md) |
| 1.9.3 | 2026-08-04 | Complete 2.0 API decision: all-domain classification and resolved compatibility decisions | [notes](../releases/1.9.3/release-notes.md) |
| 1.9.4 | 2026-08-10 | Numerical trust closure: independent references, adversarial cases, and published accuracy/failure budgets | [notes](../releases/1.9.4/release-notes.md) |
| 1.9.5 | 2026-08-11 | Predictable performance: reproducible time/allocation baselines and evidence-led optimisation | [notes](../releases/1.9.5/release-notes.md) |
| 1.9.6 | 2026-08-11 | Portability and distribution: clean archives, offline use, and an evidence-backed support matrix | [notes](../releases/1.9.6/release-notes.md) |
| 1.9.7 | 2026-08-12 | Migration and compatibility rehearsal: complete 1.x mappings and a tested compatibility plan | [notes](../releases/1.9.7/release-notes.md) |
...
and tested. See the [dense solver guide](../guides/domains/dense-linear-algebra.md#choose-a-dense-solver)
