...
[support matrix](../project/support.md), not inferred from capability maturity.
...
each at orders zero and one, Legendre elliptic integrals K/E/F, and real
exponential integrals Ei/E1, and real Gauss 2F1 in a bounded series domain.
They do not change the 2.0.0 capability classification; Jacobi elliptic
functions, other elliptic forms, analytic continuation, and complex
hypergeometric or exponential-integral branches remain unimplemented.
...
[dense solver-selection guide](../guides/domains/dense-linear-algebra.md#choose-a-dense-solver)
and [sparse solver-selection guide](../guides/domains/sparse-linear-algebra.md#choose-an-iterative-solver)
name the stable linear-algebra boundaries. The
[applied numerics guide](../guides/domains/applied-numerics.md) covers the other mature workflows.
