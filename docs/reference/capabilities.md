...
exponential integrals Ei/E1. They do not change the 2.0.0 capability
classification; Jacobi elliptic functions, other elliptic forms, and complex
exponential-integral branches remain unimplemented.
