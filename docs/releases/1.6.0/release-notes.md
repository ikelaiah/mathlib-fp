...
Start with the [dense solver-selection guide](../../guides/domains/dense-linear-algebra.md) and run
...
[qualification report](qualification.md) records the configurations and
normalized measures.
...
[the migration guide](../../guides/migration/to-typed-dense.md).
