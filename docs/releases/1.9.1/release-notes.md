...
- The [1.9 feedback route](../../project/feedback.md) asks specifically about installation
...
[1.9 capability inventory](../../reference/capabilities.md) are unchanged; 1.9.1 does not pull
forward any 1.9.2 learning-path or later convergence work.

See the [1.9.1 qualification report](qualification.md) for the exact
