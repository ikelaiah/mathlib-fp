...
- A concise [all-domain common-path map](../../reference/api/common-paths-2.0.md) points to 13
  complete output-checked programs while the generated declaration reference
  remains exhaustive.
- [Complete conventions](../../reference/api/conventions-2.0.md) resolve naming, indexing,
...
- The [exact proposed diff](../../reference/api/diff-1.9-to-2.0.md) records no source,
...
[capability inventory](../../reference/capabilities.md). The zero experimental declaration
