...
The [numerical modelling guide](../../guides/domains/numerical-modelling.md) and
[convex optimisation guide](../../guides/domains/convex-optimization.md) contain 60-second examples,
...
The [1.7 qualification report](qualification.md) lists configurations
