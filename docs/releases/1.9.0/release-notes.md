...
The [sparse linear-algebra guide](../../guides/domains/sparse-linear-algebra.md) documents every
...
The [candidate 2.0 contract](../../reference/api/candidate-2.0.md) and
[migration preview](../../guides/migration/to-2.0-preview.md) are documentation and
...
[1.9 qualification report](qualification.md).
