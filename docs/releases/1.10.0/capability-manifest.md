...
| Additional domains or algorithm families | Deferred beyond 2.0 | New domains require the [governance](../../project/governance.md) contribution gate |
...
[1.9.9 API snapshot and diff](../1.9.9/api-snapshot-final.md) record an empty
