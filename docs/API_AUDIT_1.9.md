...
| Documentation execution | all Pascal fences inventoried; all self-contained programs compiled and run; every release-facing 1.9 Pascal fence required to be self-contained | `test_doc_examples.py`; `check_doc_examples.py`; qualification archive gate | Verified |
