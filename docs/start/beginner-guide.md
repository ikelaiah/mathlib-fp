...
[typed dense ownership contract](../guides/domains/typed-dense-matrices.md#complete-storage-contract) or the
[sparse storage contract](../guides/domains/sparse-linear-algebra.md#compressed-storage-contract)
...
with an uninitialised result. The [iteration status reference](../guides/domains/numerical-modelling.md#termination-results)
...
[typed conversion rules](../guides/domains/typed-dense-matrices.md#compatibility-and-copy-costs) before moving
