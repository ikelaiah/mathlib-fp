...
APIs, see the [numerical modelling guide](numerical-modelling.md). The APIs on
...
| Smooth finite integral | `SimpsonRule` for teaching, `IntegrateAdaptive` for diagnostics | [Modelling selection](numerical-modelling.md#choose-an-algorithm) |
...
| Fitting/vector equations/adaptive ODE | `TModellingKit` | [Numerical modelling](numerical-modelling.md#choose-an-algorithm) |
