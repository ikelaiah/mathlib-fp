...
[newcomer guide](../../start/beginner-guide.md) before selecting another precision.
...
checked binary interchange. See the [applied numerics guide](applied-numerics.md)
