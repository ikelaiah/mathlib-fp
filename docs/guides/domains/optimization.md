...
[convex optimisation guide](convex-optimization.md). The APIs on this page
...
| Dense convex QP/SOCP | `TConvexOptimizationKit` | [Convex solver choice](convex-optimization.md#choose-a-solver) |
