...
and its human-readable [explanation](CAPABILITY_MANIFEST_1.10.0.md) close
...
The [final snapshot and exact diff](API_SNAPSHOT_FINAL_1.9.9.md) confirm the
...
- The [provenance audit](PROVENANCE_AUDIT_1.9.9.md) covers every stable
...
- The [governance policies](GOVERNANCE.md) complete the 2.x maintenance
...
Local evidence is recorded in [QUALIFICATION_1.9.9.md](QUALIFICATION_1.9.9.md).
...
- Deferred families remain visible as unsupported in the
  [capability inventory](CAPABILITIES.md) until a future design activates
  them.
